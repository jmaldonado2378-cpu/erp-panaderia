...
import {
    ...
    RotateCcw, ChevronDown, ChevronUp, Eye, Users, UserCircle
} from 'lucide-react';
        ...
        <AntigravitySystem>
            <div className="flex h-screen bg-slate-50 font-sans text-slate-900 overflow-hidden text-left">
                ...
                <main className="flex-1 overflow-y-auto p-10 relative bg-slate-50 print:p-0 print:bg-white">
                    ...
                    {view === 'rrhh' && <RRHHView operatives={operatives} setOperatives={setOperatives} config={config} showToast={showToast} />}
...
function RRHHView({ operatives, setOperatives, config, showToast }) {
    const [showAdd, setShowAdd] = useState(false);
    ...
    return (
        <div className="space-y-6 animate-in fade-in max-w-4xl">
            ...
            <Card className="fall-target p-6 border-t-8 border-indigo-500 bg-indigo-50/30 shadow-md">
                <div className="flex items-center gap-3 mb-5 border-b border-indigo-200 pb-3"><Users className="text-indigo-600" size={24} /><h4 className="text-xl font-black uppercase italic text-indigo-900">Parámetros de Planta (RRHH)</h4></div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
